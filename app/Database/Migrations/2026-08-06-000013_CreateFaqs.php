...
/**
 * faqs — Supabase 스키마(supabase/01_schema.sql 계열)를 MySQL 5.6 으로 옮긴 것.
...
class CreateFaqs extends Migration
{
    public function up()
    {
        $this->forge->addField([
            ...
            'page' => ['type'=>'VARCHAR','constraint'=>64,'default'=>'home'],
            'q' => ['type'=>'TEXT','null'=>true],
        ...
        $this->forge->createTable('faqs', true, ['DEFAULT CHARSET' => 'utf8mb4', 'COLLATE' => 'utf8mb4_unicode_ci']);
    }
