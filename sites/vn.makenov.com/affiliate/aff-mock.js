  ...
  function seed(){
    const campaigns = [
      { product_id:'p9', name:'Kem dưỡng chân cao cấp 3WB Gounbal', brand:'WELLBEING HEALTH FARM', cat:'beauty',
        ...
        keywords:['kem dưỡng gót chân','nứt gót chân','mỹ phẩm Hàn Quốc','nguồn hàng Hàn Quốc','sỉ mỹ phẩm','nhà phân phối mỹ phẩm'],
      ...
      { product_id:'p11', name:'MIRALET Phyto Intensive Skinbooster 2,0ml × 4', brand:'MIRALET', cat:'beauty',
        ...
        keywords:['skinbooster','PDRN','mỹ phẩm spa','clinic thẩm mỹ','nguồn hàng spa Hàn Quốc','sỉ skinbooster'],
      ...
      { product_id:'p0', name:'Chăn chữa cháy cách ly oxy FIRESSAK FS-EV54S', brand:'FIRESSAK', cat:'tech',
        ...
        keywords:['chăn chữa cháy','cháy xe điện','PCCC','trạm sạc xe điện','bãi đỗ xe ngầm','thiết bị PCCC Hàn Quốc'],
